...
namespace WebAPI.Controllers
{
    ...
    public class TelemetryController : ControllerBase
    {
        ...
        public TelemetryController(ILogger<TelemetryController> logger, TelemetryClient telemetryClient)
        {
            _logger = logger;
        ...
        [HttpGet("/customevent/{message}", Name = "GetCustomEvent")]
        public IActionResult GetTrackEvent(string message)
        {
            this._telemetryClient.TrackEvent($"Test Custom Event: {message }");
            return Ok();
        }
